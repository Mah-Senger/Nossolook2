...
if(isset($_SESSION["carrinho"][$id])){
   $texto= "Você já tem esse produto no seu carrinho.<br><a href='descricao_produto.php?id_produto=$id'>Voltar à descrição do produto</a><br>Ou<br><a href='carrinho.php'>Ir ao carrinho</a>";
